...
Function continueConversation($messages : Collection) : cs:C1710.AIKit.OpenAIChatCompletionsResult
	...
	$response_format.json_schema.schema.properties.messages.items.required:=["name"; "description"]
	$response_format.json_schema.schema.properties.messages.items.additionalProperties:=False:C215
	$response_format.json_schema.schema.properties.messages.items.properties.data:={type: "string"}
	$response_format.json_schema.schema.properties.messages.items.properties.description:={type: "string"}
